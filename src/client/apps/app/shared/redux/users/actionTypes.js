...
export const CHANGE_ROLE_REQUEST = `${BASE}/${NAME}/ChangeRoleRequest`;
export const CHANGE_ROLE_SUCCESS = `${BASE}/${NAME}/ChangeRoleSuccess`;
export const CHANGE_ROLE_FAILURE = `${BASE}/${NAME}/ChangeRoleFailure`;
